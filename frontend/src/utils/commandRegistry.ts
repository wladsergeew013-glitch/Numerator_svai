...
export const RIBBON_COMMANDS: RibbonCommandDefinition[] = [
  ...
  { id: 'edit.copyProps', section: 'Редактирование', label: 'Копия группы', defaultIcon: '🧾' },
  { id: 'edit.info', section: 'Редактирование', label: 'О точке', defaultIcon: 'ℹ' },
  { id: 'groups.manager', section: 'Группы', label: 'Группы', defaultIcon: '▤' },
  { id: 'groups.assign', section: 'Группы', label: 'В группу', defaultIcon: '☑' },
  { id: 'numbering.fullPath', section: 'Нумерация', label: 'Порядок', defaultIcon: '⛓' },
  { id: 'numbering.animation', section: 'Нумерация', label: 'Анимация', defaultIcon: '▶' },
  { id: 'numbering.clearLinks', section: 'Нумерация', label: 'Убрать связи', defaultIcon: '🧹' },
  { id: 'numbering.group', section: 'Нумерация', label: '№ группы', defaultIcon: '№' },
  { id: 'numbering.all', section: 'Нумерация', label: '№ всех', defaultIcon: '№№' },
